...
namespace Homework5
{
    public class HW5
    {
        public void SolveTask1()
        {
            ...
            int a = UserInput("Введите количество строк массива");
            int b = UserInput("Введите количество столбцов массива");
        ...
        public void SolveTask6()
        {
            ...
            int a = UserInput("Введите количество строк и столбцов массива");
            int b = a;
            int[,] array = FillArrayOfRandom(a, b);
            OutputArray(array);
            Console.WriteLine();
